...
public class WeaponResourceCreationHelper
{
    ...
    private static Dictionary<WeaponAnimType, List<string>> dictStandardWeaponAnimTypeToAnimationClipNameList = new Dictionary<WeaponAnimType, List<string>>()
    {
        ...
        { WeaponAnimType.ANIM_FIRE , new List<string>(){ "fire" , "fire_raw", "shoot" , "shoot1"} },
        { WeaponAnimType.ANIM_RELOAD , new List<string>(){ "reload" , "reload1" } },
    ...
    [MenuItem("Assets/QC/2. Populate weapon resource (Click on QC file)")]
    public static void PopulateWeaponResourceByQc()
    {
        ...
        // Finds all animations in the folder
        ...
        MapStandardAnimationClipToResource(context);
    ...
    private static void MapStandardAnimationClipToResource(WeaponImportContext context)
    {
    ...
    {
        string clipFileNameNoExt = Path.GetFileNameWithoutExtension(animationClipName).ToLower();
