...
namespace EasyCharacterMovement
{
    ...
    public class MzEcmFpCharacter : Character
    {
        #region EDITOR EXPOSED FIELDS
        public float weaponRecoilInput = 0f;
        ...
        protected override void InitPlayerInput()
        {
            ...
            mouseLookInputAction = inputActions.FindAction("MouseLook");
        ...
        protected override void OnLateUpdate()
        {
            ...
            // Temporarily disabled as no crouching
            // AnimateEye();
        ...
        {
            // Override NOT to do simulate here because mouse move is not smooth
            // Simulate(Time.deltaTime);
        }

        private float TakeWeaponRecoil()
        {
            float returnVal = weaponRecoilInput;
            weaponRecoilInput = 0;
            return returnVal;
        }
